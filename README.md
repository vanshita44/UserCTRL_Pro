...
### 2. *Audit Reporting and Automation*
...
* **generate_audit.sh**: Generates and saves a system audit report.
* **send_report.sh**: Sends the audit report via email and archives it.
